...
![image](img/screenshot-4-2.png)
![image](img/screenshot-4-3.png)

- 구현한 내용 (위 그림 참조)
- 기존에는 단순 파일만 관리할 수 있었지만, 폴더도 관리할 수 있도록 기능을 확장하였다.
- 기존 PopulateListView함수에 폴더 관리 전용 코드를 추가하여 파일 처럼 복사/덮어쓰기가 가능하고 폴더도 색상으로 구분되도록 하였다.
